...
namespace Rent_a_Car.Components.Tables
{
    ...
    /// </summary>
    internal class ManutencaoHistTable : DataGridView
    {
        private int[] _margin = { 0, 0, 0, 0 };

        public ManutencaoHistTable()
        {
            Emp.manutencaoHistTable = this;
            ...
            this.Columns[col++].Name = "problema";
        ...
        public ManutencaoHistTable(int margin_top, int margin_right, int margin_bottom, int margin_left) : this()
        {
        ...
        private void onCellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ManutencaoHist clickedManutencao = new ManutencaoHist(-1, "", DateTime.Now, DateTime.Now, "", -1);

            int length = Emp.ManutencaoHistList.Count;
            for (int i = 0; i < length; i++)
            {
                ManutencaoHist r = Emp.ConvertObj(Emp.ManutencaoHistList[i]);
        ...
        public void FillData(ArrayList list, int days = 0)
        {
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                this.Rows.Add(convertedItem.IdVeiculo, matricula, convertedItem.TipoVeiculo, convertedItem.DataInicio.Date.ToShortDateString(), convertedItem.DataFim.Date.ToShortDateString(), convertedItem.Problema, convertedItem.Valor, "Detalhes");
            }
        }
    }
}
