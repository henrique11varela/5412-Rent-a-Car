...
namespace Rent_a_Car.Components.Tables
{
    ...
    internal class AlugadoTable : DataGridView
    {
        ...
        public AlugadoTable(int margin_top, int margin_right, int margin_bottom, int margin_left) : this()
        {
        ...
        private void onCellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            int length = Emp.AlugadoList.Count;
            for (int i = 0; i < length; i++)
            {
                Alugado r = Emp.ConvertObj(Emp.AlugadoList[i]);
