...
{
    internal class StateListControls : Panel
    {
        ...
        #region Constructors
        public StateListControls()
        {
            Emp.stateListControls = this;
            ParentChanged += Setup;
            BackColor = ts.light;
        }

        public StateListControls(int margin_top, int margin_right, int margin_bottom, int margin_left) : this()
        {
